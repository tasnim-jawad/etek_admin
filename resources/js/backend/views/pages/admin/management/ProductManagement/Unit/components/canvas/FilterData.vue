        ...
        <div class="off_canvas_body">
            ...
            <div class="data_content" ref="data_content">
                ...
                <div class="filter_item">
                    ...
                    <button @click.prevent="clear_filter_data();" type="button" class="btn ml-2 btn-sm btn-danger">
                        Clear
                    </button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        clear_filter_data: function () {
            let inputs = this.$refs.data_content.querySelectorAll('.form-control');
            [...inputs].forEach(i => i.value = '');
            this.filter.start_date = '';
            this.filter.end_date = '';
            this.clear_filter_criteria();
            this.set_filter_criteria(false);
        }
    },
    computed: {
