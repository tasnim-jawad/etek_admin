        ...
        async function up_p(position) {
            ...
            try {
                processing.innerHTML = `
                    ${start + 1} / 63601
                `;
                document.querySelector('title').innerHTML = `${start + 1} / 63601`;

                if (start <= 63601 ) {
                    let res = await fetch(`/up-product-image-s3?si=${start}`, {
                        method: 'POST',
                        headers: {
                ...
                percent.innerHTML = (100 * position / 63601 ).toFixed(1) + ' %';
            } catch (error) {
                document.querySelector('title').innerHTML = "got error";
                throw error;
            }
            ...
            if (!is_error) {
                ...
                document.querySelector('title').innerHTML = "got error "+start;
            }
